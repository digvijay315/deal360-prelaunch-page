...
export default function ConnectionVerification() {
  ...
  const t = useTranslations('everyconnection')
  return (
    <section className="bg-white w-full  flex items-center overflow-hidden dark:bg-black font-[Poppins]">
      <div className="w-full mx-auto px-0  py-12 sm:py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16">

          {/* ── Left: text content ── */}
          <div className=" md:pt-20 flex flex-col gap-4 sm:gap-6 w-full lg:w-1/2 lg:flex-shrink-0  pl-4 sm:pl-8 md:pl-12 lg:pl-16 xl:pl-24 2xl:pl-48">
            ...
            {/* Feature items */}
            <div className="mt-2 sm:mt-2 lg:mt-4">
          ...
          <div className="w-full lg:w-full flex items-center justify-center lg:justify-end relative">
            <picture className="w-full max-w-xs sm:max-w-sm lg:max-w-none">
              <source
                ...
                srcSet={publicAsset("Monitor.png")}
              />
              <img
                src={publicAsset("Monitor.png")}
                alt="Monitor"
...
function FeatureItem({ label, icon }: FeatureItemProps) {
  return (
