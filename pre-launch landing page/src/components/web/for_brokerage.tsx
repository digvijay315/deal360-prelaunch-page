...
export default function ForBrockerage() {
  ...
  return (
    <main className="bg-white min-h-screen overflow-x-hidden  dark:bg-black">
...
function HeroSection({ setregistration_modal }: { setregistration_modal: (value: boolean) => void }) {
  const t = useTranslations("forBrokerage");
    ...
    <div className="relative w-full mx-auto">
      <div className="flex flex-col lg:flex-row lg:items-stretch gap-2">
        ...
        <div className="lg:w-[60%] flex flex-col px-8 sm:pl-8 md:pl-12 lg:pl-16 xl:pl-24 2xl:pl-48 pb-6">
          ...
          {/* Body copy */}
          <p className="font-normal leading-[150%] mb-4 mt-8 text-[var(--color-text)] dark:text-white/70" style={{ fontSize: "clamp(15px, 1.2vw, 20px)", }}>
            {t("hero.body1_start")}{" "}
            <b>{t("hero.body1_bold")}</b>{" "}
            {t("hero.body1_end")}
          </p>

          <p className="font-normal leading-[150%] mb-4 text-[var(--color-text)] dark:text-white/70" style={{ fontSize: "clamp(15px, 1.2vw, 20px)", }}>
            {t("hero.body2")}
          </p>

            <p className="font-normal leading-[150%] mb-8 mt-2 text-[var(--color-text)] dark:text-white" style={{ fontSize: "clamp(15px, 1.2vw, 20px)", fontWeight: 500 }}>
            {t("hero.body4")}
          </p>

          <p className="font-normal leading-[150%] mb-8 mt-6 text-[var(--color-text)] dark:text-white" style={{ fontSize: "clamp(15px, 1.2vw, 20px)", fontWeight: 500 }}>
            {t("hero.body3")}
          </p>

               <p className="font-normal leading-[150%] mb-8 text-[var(--color-text)] dark:text-white/70" style={{ fontSize: "clamp(15px, 1.2vw, 20px)", }}>
            {t("hero.body5")}
          </p>
          ...
          <div className="lg:hidden w-full mb-8 flex justify-center relative">
            <picture className="w-full max-w-xs sm:max-w-sm">
              <source
                ...
                srcSet={publicAsset("wepowerborkerage.png")}
              />
              <img
                src={publicAsset("wepowerborkerage.png")}
                alt="Monitor"
        ...
        <div className="hidden lg:flex lg:w-[40%] relative">
          ...
          <div className="w-full flex items-start justify-end relative">
            ...
            <img
              src={publicAsset('/brokermonitor.png')}
              alt="Monitor"
              className="w-full h-auto object-contain"
            />
...
function FeaturesSection() {
  ...
  const features = [
      ...
      icon: (
        <FeatureIconCircle>
          <svg xmlns="http://www.w3.org/2000/svg" width="115" height="115" viewBox="0 0 115 115" fill="none">
            ...
            <defs>
              <filter id="filter0_d_58891_35639" x="-8.10623e-05" y="0.000163078" width="114.667" height="114.667" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
    ...
    },
    {
      ...
      desc: t("features.performanceAnalytics.desc"),
      icon: (
        /* This icon is a self-contained SVG circle from the Figma */
        <FeatureIconCircle>
          <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
            <path d="M28.4492 34.834H34.8301" stroke="white" strokeWidth="2.375" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3.16797 3.16602V30.0827C3.16797 32.711 5.28964 34.8327 7.91797 34.8327H22.1363" stroke="white" strokeWidth="2.375" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M31.6484 12.9523L33.2476 11.084" stroke="white" strokeWidth="2.375" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.91797 26.9158L15.1855 18.4291C16.3888 17.0358 18.5263 16.9408 19.8246 18.2549L21.3288 19.7591C22.6271 21.0575 24.7646 20.9783 25.968 19.5849L27.7888 17.4474" stroke="white" strokeWidth="2.375" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </FeatureIconCircle>
      ),
    },
    {
      id: 3,
      title: t("features.listingOversight.title"),
      desc: t("features.listingOversight.desc"),
      icon: (
        <FeatureIconCircle>
    ...
    {
      id: 4,
      title: t("features.engagementWithVerifiedDemand.title"),
      desc: t("features.engagementWithVerifiedDemand.desc"),
      icon: (
        <FeatureIconCircle>
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="28" viewBox="0 0 39 28" fill="none">
            <path d="M36.125 2.125L12.75 25.5L2.125 14.875" stroke="white" strokeWidth="4.25" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </FeatureIconCircle>
      ),
    },
